                ...
                <div class="card" >
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-body-secondary">
                            <?php
                            $total_menu = mysqli_query($connection, "SELECT COUNT(no_menu) AS total FROM menu WHERE type_menu = 'main_course'");
            ...
            <div class="col">
                <div class="card" >
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-body-secondary">
                            <?php
                            $average_price = mysqli_query($connection, "SELECT AVG(price) AS average FROM menu WHERE type_menu = 'main_course'");
